...
public class MiuiDialog {
    ...
    public MiuiDialog(Context context) {
        ...
        newInstance = ReflectUtils.newInstance(miuiClass, context);
    }
    ...
    public MiuiDialog(Context context, int value) {
        this.context = context;
        miuiClass = findClass(new PathClassLoader(pathJar, ClassLoader.getSystemClassLoader()));
        newInstance = ReflectUtils.newInstance(miuiClass, context, value);
    }
    ...
    private Class<?> findClass(ClassLoader classLoader) {
        Class<?> clz = ReflectUtils.findClassIfExists(path, classLoader);
    ...
    public static class Builder {
        ...
        public Builder setTitle(int id) {
            newInstance = ReflectUtils.callMethod(newInstance, "setTitle", id);
            return this;
        }

        public Builder setTitle(CharSequence charSequence) {
            newInstance = ReflectUtils.callMethod(newInstance, "setTitle", charSequence);
            return this;
        }

        public Builder setHapticFeedbackEnabled(boolean z) {
            newInstance = ReflectUtils.callMethod(newInstance, "setHapticFeedbackEnabled", z);
            return this;
        }

        public Builder setMessage(int id) {
            newInstance = ReflectUtils.callMethod(newInstance, "setMessage", id);
            return this;
        }

        public Builder setMessage(CharSequence charSequence) {
            newInstance = ReflectUtils.callMethod(newInstance, "setMessage", charSequence);
            return this;
        }

        public Builder setNegativeButton(int id, DialogInterface.OnClickListener onClickListener) {
            newInstance = ReflectUtils.callMethod(newInstance, "setNegativeButton", id, onClickListener);
            return this;
        }

        public Builder setNegativeButton(CharSequence charSequence, DialogInterface.OnClickListener onClickListener) {
            newInstance = ReflectUtils.callMethod(newInstance, "setNegativeButton", charSequence, onClickListener);
            return this;
        }

        public Builder setNeutralButton(int id, DialogInterface.OnClickListener onClickListener) {
            newInstance = ReflectUtils.callMethod(newInstance, "setNeutralButton", id, onClickListener);
            return this;
        }

        public Builder setNeutralButton(CharSequence charSequence, DialogInterface.OnClickListener onClickListener) {
            newInstance = ReflectUtils.callMethod(newInstance, "setNeutralButton", onClickListener);
            return this;
        }

        public Builder setPositiveButton(int id, DialogInterface.OnClickListener onClickListener) {
            newInstance = ReflectUtils.callMethod(newInstance, "setPositiveButton", id, onClickListener);
            return this;
        }

        public Builder setPositiveButton(CharSequence charSequence, DialogInterface.OnClickListener onClickListener) {
            newInstance = ReflectUtils.callMethod(newInstance, "setPositiveButton", onClickListener);
            return this;
        }

        public void show() {
            newInstance = ReflectUtils.callMethod(newInstance, "create");
            ReflectUtils.callMethod(newInstance, "show");
        }

        private Class<?> findClass(ClassLoader classLoader) {
            Class<?> clz = ReflectUtils.findClassIfExists(pathBuilder, classLoader);
